...
End Sub
    ...
    Public Sub minqpsetlcmixed(ByVal state As minqpstate, ByVal densec(,) As Double, ByVal densect() As Integer, ByVal densek As Integer, ByVal sparsec As sparsematrix, ByVal sparsect() As Integer, ByVal sparsek As Integer)
        Try
            alglib.minqpsetlcmixed(state.csobj, densec, densect, densek, sparsec.csobj, sparsect, sparsek)
        Catch _E_Alglib As alglib.alglibexception
            Throw New AlglibException(_E_Alglib.Msg)
        End Try
    End Sub
    ...
    Public Sub minbcoptimize(ByVal state As minbcstate, ByVal func As ndimensional_func, ByVal rep As ndimensional_rep, ByVal obj As Object)
        ...
        End If
        Try
            While alglib.minbc.minbciteration(innerobj)
                If innerobj.needf Then
                    func(innerobj.x,  innerobj.f, obj)
                    Continue While
                End If
    ...
    Public Sub minbcsetgradientcheck(ByVal state As minbcstate, ByVal teststep As Double)
        Try
            alglib.minbcsetgradientcheck(state.csobj, teststep)
        Catch _E_Alglib As alglib.alglibexception
            Throw New AlglibException(_E_Alglib.Msg)
        End Try
    End Sub
    ...
    Public Sub eigsubspacesolvedenses(ByVal state As eigsubspacestate, ByVal a(,) As Double, ByVal isupper As Boolean, ByRef w() As Double, ByRef z(,) As Double, ByRef rep As eigsubspacereport)
        ...
        End Try
    End Sub
    Public Sub smp_eigsubspacesolvedenses(ByVal state As eigsubspacestate, ByVal a(,) As Double, ByVal isupper As Boolean, ByRef w() As Double, ByRef z(,) As Double, ByRef rep As eigsubspacereport)
        Try
    rep = New eigsubspacereport()
    alglib.smp_eigsubspacesolvedenses(state.csobj, a, isupper, w, z, rep.csobj)
    ...
    Public Sub pcabuildbasis(ByVal x(,) As Double, ByVal npoints As Integer, ByVal nvars As Integer, ByRef info As Integer, ByRef s2() As Double, ByRef v(,) As Double)
        ...
        End Try
    End Sub
    Public Sub smp_pcabuildbasis(ByVal x(,) As Double, ByVal npoints As Integer, ByVal nvars As Integer, ByRef info As Integer, ByRef s2() As Double, ByRef v(,) As Double)
        Try
    alglib.smp_pcabuildbasis(x, npoints, nvars, info, s2, v)
    ...
    Public Sub pcatruncatedsubspace(ByVal x(,) As Double, ByVal npoints As Integer, ByVal nvars As Integer, ByVal nneeded As Integer, ByVal eps As Double, ByVal maxits As Integer, ByRef s2() As Double, ByRef v(,) As Double)
        ...
        End Try
    End Sub
    Public Sub smp_pcatruncatedsubspace(ByVal x(,) As Double, ByVal npoints As Integer, ByVal nvars As Integer, ByVal nneeded As Integer, ByVal eps As Double, ByVal maxits As Integer, ByRef s2() As Double, ByRef v(,) As Double)
        Try
    alglib.smp_pcatruncatedsubspace(x, npoints, nvars, nneeded, eps, maxits, s2, v)
    ...
    Public Sub rbfgridcalc2v(ByVal s As rbfmodel, ByVal x0() As Double, ByVal n0 As Integer, ByVal x1() As Double, ByVal n1 As Integer, ByRef y() As Double)
        ...
        End Try
    End Sub
    Public Sub smp_rbfgridcalc2v(ByVal s As rbfmodel, ByVal x0() As Double, ByVal n0 As Integer, ByVal x1() As Double, ByVal n1 As Integer, ByRef y() As Double)
        Try
    alglib.smp_rbfgridcalc2v(s.csobj, x0, n0, x1, n1, y)
    ...
    Public Sub rbfgridcalc2vsubset(ByVal s As rbfmodel, ByVal x0() As Double, ByVal n0 As Integer, ByVal x1() As Double, ByVal n1 As Integer, ByVal flagy() As Boolean, ByRef y() As Double)
        ...
        End Try
    End Sub
    Public Sub smp_rbfgridcalc2vsubset(ByVal s As rbfmodel, ByVal x0() As Double, ByVal n0 As Integer, ByVal x1() As Double, ByVal n1 As Integer, ByVal flagy() As Boolean, ByRef y() As Double)
        Try
    alglib.smp_rbfgridcalc2vsubset(s.csobj, x0, n0, x1, n1, flagy, y)
    ...
    Public Sub rbfgridcalc3v(ByVal s As rbfmodel, ByVal x0() As Double, ByVal n0 As Integer, ByVal x1() As Double, ByVal n1 As Integer, ByVal x2() As Double, ByVal n2 As Integer, ByRef y() As Double)
        ...
        End Try
    End Sub
    Public Sub smp_rbfgridcalc3v(ByVal s As rbfmodel, ByVal x0() As Double, ByVal n0 As Integer, ByVal x1() As Double, ByVal n1 As Integer, ByVal x2() As Double, ByVal n2 As Integer, ByRef y() As Double)
        Try
    alglib.smp_rbfgridcalc3v(s.csobj, x0, n0, x1, n1, x2, n2, y)
    ...
    Public Sub rbfgridcalc3vsubset(ByVal s As rbfmodel, ByVal x0() As Double, ByVal n0 As Integer, ByVal x1() As Double, ByVal n1 As Integer, ByVal x2() As Double, ByVal n2 As Integer, ByVal flagy() As Boolean, ByRef y() As Double)
        ...
        End Try
    End Sub
    Public Sub smp_rbfgridcalc3vsubset(ByVal s As rbfmodel, ByVal x0() As Double, ByVal n0 As Integer, ByVal x1() As Double, ByVal n1 As Integer, ByVal x2() As Double, ByVal n2 As Integer, ByVal flagy() As Boolean, ByRef y() As Double)
        Try
    alglib.smp_rbfgridcalc3vsubset(s.csobj, x0, n0, x1, n1, x2, n2, flagy, y)
